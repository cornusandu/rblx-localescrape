...
Roblox.LangDynamic["Feature.ReportAbuse"] = {
    ...
    "Label.ModeratorNote":
        "NOTE: Deleting this post you will also delete replies. If you choose to scrub or delete the post, this report will skip the abuse queue and go directly to the user queue.",
    ...
    "Label.BlockWarning":
        "Users who don't follow the rules will get a warning at first but if they keep it up we may ask them to not come to Roblox anymore. That way we can keep Roblox fun and safe!",
    ...
    "Message.ThankYou":
        "Thank you for your report.  We will investigate further to determine if there has been a violation of our Terms of Use.  For more information check out ",
    ...
    "DSAIllegal.ReportLink": "Report illegal content under the EU Digital Services Act.",
    ...
    "Message.OSACopy2":
        "The user or content you reported won’t be blocked automatically. If you want to limit your interactions with a user, you can block them.",
    "Message.OSACopy3": "You can also report illegal content under the UK Online Safety Act.",
    "Message.OSACopy4": "Report illegal content and/or content harmful to children.",
    "Message.OSACopyReadOnly": "To report illegal content and/or content harmful to children, visit: https://www.roblox.com/illegal-content-reporting",
    "Message.ReportInformationCopy":
        "We'll review your report and take appropriate action. We won't share your information with any user you report. Reporting a user or content won't block them automatically.",
};
