...
Roblox.LangDynamic["Feature.SessionManagement"] = {
    ...
    "Description.OldSessionsWithUnknownData": "These are old sessions with unknown data. They will be updated if there is new activity.",
    "Action.LogOut": "Log Out",
    "Action.LogOutAllSessions": "Log Out of All Other Sessions",
    "Action.LogOutOfSession": "Log Out of Session",
    "Description.CurrentlyLoggedIn": "These are all the places you're currently logged into your Roblox account.",
    "Description.YouWillBeLoggedOut": "You will be logged out of the selected session. Are you sure?",
    "Description.YouWillBeLoggedOutAllSessions": "You will be logged out of all other sessions. Are you sure?",
    ...
    "Description.ConsoleLogoutDisclaimer": "To log out of console, you must use the Disconnect button above.",
...
window.Roblox && window.Roblox.BundleDetector && window.Roblox.BundleDetector.bundleDetected("DynamicLocalizationResourceScript_Feature.SessionManagement");
