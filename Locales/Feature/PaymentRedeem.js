...
Roblox.LangDynamic["Feature.PaymentRedeem"] = {
    ...
    "Response.UnrecognizedMerchant": "We currently do not support the merchant you purchased this card from, please contact Customer Service.",
    ...
    "Description.SubscriptionBillingEmail": "This email address will only be used for billing. It won’t replace other emails associated with this account. ",
    "Label.BillingEmail": "Billing Email",
    "Label.AvailableCredit": "Available Credit",
    "Label.EnterCode": "Enter Code",
    "Description.EnterCodeHelpText": "This can be found on the back of physical gift cards or in the confirmation email for digital gift cards.",
    ...
    "Description.SubscriptionBillingEmailTooltip": "A valid email is required for subscriptions billing notifications.",
    "Description.SubscriptionParentBillingEmail": "To make changes, update the parental account email in settings.",
