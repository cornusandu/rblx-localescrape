...
Roblox.LangDynamic["Authentication.OneTimePasscode"] = {
    ...
    "Description.U13SignupOneTimePasscodeEmail.V1.Body":
    ...
    "Description.U13SignupOneTimePasscodeEmail.V2.Body":
    ...
    "Description.ReauthOneTimePasscodeEmail.V1.Body":
        "Hello,{lineBreak}{lineBreak}{boldStart}{code}{boldEnd} is your Roblox One-Time Code. Enter it onto your screen. This code will expire in 15 minutes.{lineBreak}{lineBreak}Do {boldStart}not{boldEnd} share this code. We will {boldStart}never{boldEnd} contact you to ask for it. If you did not request this code, there is no further action you need to take. If you receive numerous codes you did not request, we strongly encourage you to link a different email to your account(s) and {linkTagWithAuthenticatorHelpLinkStart}set up 2-Step Verification by Authenticator App{linkTagEnd}.{lineBreak}{lineBreak}This Roblox One-Time Code request was received from {geolocation}.{lineBreak}{lineBreak}Thank You,{lineBreak}{lineBreak}The Roblox Team",
    ...
    "Description.ReviewAndConsentToTerms":
    ...
    "Description.KoreaConsentTerms":
        "Please review and consent to the following terms. You may choose to agree or disagree to individual terms. You may still use Roblox if you do not agree to the optional terms. ",
    ...
    "Description.CSChatbotOneTimePasscodeEmailV1.Body":
        "Hello,{lineBreak}{lineBreak} Thank you for contacting the Roblox Customer Support chatbot regarding your account {username}.{lineBreak}A code is required to proceed with the submitted chatbot request. Please enter the following code in the Roblox Customer Support chatbot: {boldStart}{code}{boldEnd}.{lineBreak}{lineBreak}Use this code only for the Roblox Customer Support chatbot.{lineBreak}If you did not request this code, you can safely ignore this email.{lineBreak}{lineBreak}Thank You,{lineBreak}{lineBreak}The Roblox Team",
    "Description.CSChatbotOneTimePasscodeEmail.V1.Subject": "Roblox Customer Support One-Time Code",
    "Description.U13CSChatbotOneTimePasscodeEmail.V1.Body":
        "Hello,{lineBreak}{lineBreak} Thank you for contacting the Roblox Customer Support chatbot regarding your child's account {username}.{lineBreak}A code is required to proceed with the submitted chatbot request. Please enter the following code in the Roblox Customer Support chatbot: {boldStart}{code}{boldEnd}.{lineBreak}{lineBreak}Use this code only for the Roblox Customer Support chatbot.{lineBreak}If you did not request this code, you can safely ignore this email.{lineBreak}{lineBreak}Thank You,{lineBreak}{lineBreak}The Roblox Team",
    "Description.ChallengeOneTimePasscodeEmail.V1.Body":
        "Hello,{lineBreak}{lineBreak}{boldStart}{code}{boldEnd} is your Roblox One-Time Code. Enter it onto your screen. This code will expire in 15 minutes.{lineBreak}{lineBreak}Do {boldStart}not{boldEnd} share this code. We will {boldStart}never{boldEnd} contact you to ask for it.{lineBreak}{lineBreak}Thank You,{lineBreak}{lineBreak}The Roblox Team",
    "Description.AccountRecoveryOneTimePasscodeEmail.V1.Header": "Roblox Account Recovery Request",
    "Description.AccountRecoveryOneTimePasscodeEmail.V1.Subject": "Roblox Account Recovery Request",
    "Description.AccountRecoveryOneTimePasscodeEmail.V1.Body":
        "Hello,{lineBreak}{lineBreak}{boldStart}{code}{boldEnd} is your Roblox Security Code. Enter it into the recovery page to recover. This code will be active for 15 mins.{lineBreak}{lineBreak} Do {boldStart}not{boldEnd} share this code. We will never contact you to ask for it.{lineBreak}{lineBreak}You are receiving this email as there was a request to reset your password. If you didn't make this request, you can just ignore this email. Please review our help article for more information on {linkTagWithAccountSecurityHelpLinkStart}Account Security{linkTagEnd}. Do not reply to this email as it will not be received. If you need assistance, please visit us at {linkTagWithRobloxSupportLinkStart}Roblox Support{linkTagEnd}.{lineBreak}{lineBreak} This recovery request was received from {geolocation}.{lineBreak}{lineBreak} Thank you,{lineBreak}{lineBreak}The Roblox Team",
    "Description.AccountRecoveryOneTimePasscodeUnder13Email.V1.Body":
    ...
    "Description.AccountRecoveryOneTimePasscodeSms.V1.Body": "{code} is your Roblox security code.",
    "Header.YourRobloxOTPCode": "Your Roblox One-Time Login Code",
};
window.Roblox &&
    window.Roblox.BundleDetector &&
    window.Roblox.BundleDetector.bundleDetected("DynamicLocalizationResourceScript_Authentication.OneTimePasscode");
