...
Roblox.LangDynamic["Feature.AccountSecurityPrompt"] = {
    ...
    "Description.AreYouSureDismissForeverAddEmailUnder13":
        "Someone might be using your account without your permission. To keep your account safe, please add your parent's email and reset your password.",
    "Description.AreYouSureDismissForeverAddEmail":
        "Someone might be using your account without your permission. To keep your account safe, please add your email and reset your password.",
    "Description.AreYouSureDismissForeverChangePassword":
        "Someone might be using your account without your permission. To keep your account safe, please change your password.",
    ...
    "Description.CheckYourEmailUnder13":
        "Please ask your parent to check the email we sent to {emailAddress} and follow the instructions to reset your password. They may need to refresh their inbox or check their spam folder.",
    "Description.CheckYourEmail":
        "Please check the email we sent to {emailAddress} and follow the instructions to reset your password. You may need to refresh your inbox or check your spam folder.",
    ...
    "Description.AccountRestoresPolicy":
        "Starting 10th Jan 2022, you must enable 2-Step Verification via Authenticator to be eligible for account restores if your account is hacked.",
    ...
    "Description.AuthenticatorSetupPrompt":
        "Your security is important to us: Open Settings to set up Authenticator and learn more on our {linkStart}help page{linkEnd}.",
    "Action.OpenSettings": "Open Settings",
    "Description.AccountRestoresPolicyWithDate":
        "Starting {date}, you must enable 2-Step Verification via Authenticator to be eligible for account restores if your account is hacked.",
    ...
    "Description.ChangeYourPasswordImmediatelyClickHereStyled":
        "To keep your account safe, please {styleTagStart}click here{styleTagEnd} to change your password immediately.",
    ...
    "Description.AuthenticatorSetupPromptNew":
    ...
    "Description.AuthenticatorSetupPromptNewShort":
        "We recommend that you enable 2-Step Verification via an authenticator app to keep your account safe. If your account is compromised, Customer Support will evaluate the security measures you put in place as we try to help you recover any lost value. Learn more on our {linkStart}help page{linkEnd}.",
    "Header.AccountRestorePolicyMessageSubject": "Enable 2-step verification via authenticator to keep your account safe",
    "Description.AccountRestorePolicyMessageBody":
        "Hi, {lineBreak}{lineBreak}We recommend that you enable 2-step verification via an authenticator app to make your account more secure. This will help keep your account safe even if your password or email is stolen. In the event that your account is ever compromised, Customer Support will evaluate the security measures you put in place as we try to help you recover any lost value. {lineBreak}{lineBreak}You can set up an authenticator app on your account by going to {securityPageLinkStart}https://www.roblox.com/my/account#!/security{linkEnd}. {lineBreak}{lineBreak}For more information, please visit our {helpPageLinkStart}help page{linkEnd}.",
    "Header.TwoStepVerificationUpdate": "2-Step Verification Update",
    "Description.AuthenticatorForcedOverEmail":
        "You have recently had 2-Step Verification via both Email and Authenticator App turned on. In most cases, to keep your account secure, you will only be allowed to verify via Authenticator.",
    "Description.AuthenticatorForcedOverEmailPresent":
        "You currently have 2-Step Verification via both Email and Authenticator App turned on. In most cases, to keep your account secure, you will only be allowed to verify via Authenticator.",
    ...
    "Description.AccountRestoresPolicyUpdateV3":
        "You can do this by going to {linkStart}Account Settings{linkEnd}. If your account is compromised, it is unlikely that Roblox will be able to restore your account or recover its value, including lost items and virtual currency.",
    ...
    "Description.Email2SVUpsellMessageBody":
        "Protect your account and valuables with security codes sent to your email. Enable Email 2-Step Verification today!",
