...
Roblox.LangDynamic["Common.VisitGame"] = {
    ...
    "Response.Dialog.PcFirefoxSecondInstruction": "Go to Downloads and double click {startBold}RobloxPlayerInstaller.exe{endBold}",
    ...
    "Response.Dialog.PcIeInstructionTwo": "Go to Downloads and double click {startBold}RobloxPlayerInstaller.exe{endBold}",
    ...
    "Response.Dialog.MacFirstInstruction": "Once downloaded, double-click the {startBold}Roblox.dmg{endBold} file in your Downloads folder.",
    "Response.Dialog.WindowsFirstInstruction": "Once downloaded, double-click the {startBold}RobloxPlayerInstaller.exe{endBold} file in your Downloads folder.",
    "Response.Dialog.SecondInstruction": "Double-click the {startBold}RobloxPlayerInstaller{endBold} to install the app.",
